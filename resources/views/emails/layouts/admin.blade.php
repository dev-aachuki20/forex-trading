<!DOCTYPE html>
    <html lang="{{$locale}}" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        <meta charset="UTF-8">
		...
		<tr>
			<td align="center" style="padding:0;">
				<table role="presentation" style="width: 100%; max-width:602px;border-collapse:collapse;border-spacing:0;text-align:left;">
					<tr>
						<td align="center" style="padding:20px 0;background:#121a2c;">
							<img src="{{ env('APP_URL').'/'.config('constants.default.logo') }}" alt="" width="300" style="height:auto;display:block;" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding:30px;background:#121a2c;">
