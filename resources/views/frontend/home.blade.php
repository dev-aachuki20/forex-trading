            ...
            <div class="col-lg-8 col-sm-12">
                <div class="home-banner-text">
                    ...
                    <div class="discription text-white body-font-large">
                        <p>Capitalize on your trading skills and amplify your returns with a funded trader account you keep up to 90% of the profits.</p>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-sm-12">
                <div class="section-head text-center">
                    ...
                    <div class="discription">
                        <p>Take a one-step Audition, and once you achieve a 10% profit target, you receive a funded account — up to $1 million. You keep up to 90% of your profits. Simple rules. No time limits. Great customer service.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="side-by-step-item">
                        <a href="#">
                            ...
                            <div class="step-details">
                                ...
                                <div class="step-details-dis">
                                    <p>You made it! Now you can utilize your trading discipline with our capital. Trade consistently and responsibly to earn real money — up to 90% of your profits.</p>
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="section-head">
                    ...
                    <div class="discription">
                        <p>Choose your tier and take the SurgeTrader Audition. The trading rules are simple and straightforward — not a complicated list with dozens of rules you need to comply with.</p>
                    </div>
                    <div class="button-group">
                        <a class="custom-btn outline-color-azul" href="#">Start Trading</a>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-sm-12">
                <div class="section-head text-center mb-5">
                    <h2>Trader Portal</h2>
                    <div class="discription">
                        <p>We know that good traders are addicted to numbers. With our platform, you can track all your trading activity through our user-friendly trader portal. Everything you need on a simple-to-use dashboard.</p>
                    </div>
