                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <div class="form-check form-switch form-switch-right form-switch-md">
                                    <a href="{{ route('auth.courses') }}" class="btn btn-success add-btn"><i class="ri-arrow-left-line"></i>
                        ...
                        <div class="card-body">
                            @if ($formMode)
                            @include('livewire.admin.course-lectures.form', ['languageId' => $languageId])
                            @elseif($viewMode)
                            @livewire('admin.course-lectures.show', ['lecture_id' => $lecture_id])
                            @else
                            <div class="listjs-table" id="customerList">
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ convertDateTimeFormat($lecture->created_at, 'date') }}
                                                </td>
                                ...
                                {{ $alllectures->links('vendor.pagination.bootstrap-4') }}
                                <!-- eng tab end -->
                            </div>
                            @endif
                        </div>
