                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    @if ($details->course_image_url)
                                    <img src="{{ $details->course_image_url }}" width="100" height="100">
                                    @else
                                    <p>No Image Found</p>
                                    @endif
                                </div>
                    ...
                    {{-- <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    @if ($details->course_video_url)
                                    <video width="200" height="200" controls>
                                        <source src="{{ $details->course_video_url }}" type="video/mp4">
                                    </video>
                                    @else
                                    <p>No Video Found</p>
                                    @endif
