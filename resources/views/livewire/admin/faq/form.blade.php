        ...
        <form wire:submit.prevent="{{ $updateMode ? 'update' : 'store' }}" class="tablelist-form mt-5"
            ...
            <div class="mb-3">
                ...
                <input type="text" wire:model="question" class="form-control"
                    placeholder="{{ $allKeysProvider['question'] }}" />
                @error('question')
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" wire:model="answer" id="" cols="30" rows="10"
                    placeholder="{{ $allKeysProvider['answer'] }}"></textarea>
                @error('answer')
                    <span class="error text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="avatar-xl mx-auto">
                    <input type="file" class="filepond filepond-input-circle" wire:model="video"
