            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if ($formMode)
                            @include('livewire.admin.featured-manage.form', [
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td>{{ convertDateTimeFormat($news->publish_date, 'date') }} -->
                                                </td>
                                                <td>
                                                    <label class="switch">
                                                        <input wire:click.prevent="toggle({{ $news->id }},{{$loop->iteration}})" class="switch-input" id="switch-input-{{$activeTab}}-{{$loop->iteration}}" type="checkbox" {{ $news->status == 1 ? 'checked' : '' }} />
                                                        <span class="switch-label" data-on="{{ $statusText }}" data-off="deactive"></span>
                                                        <span class="switch-handle"></span>
                                                    </label>
                                                </td>

                                                <td>{{ convertDateTimeFormat($news->created_at, 'date') }}
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <div class="remove">
                                                            <a class="btn btn-sm btn-danger remove-item-btn" href="{{ $news->pdf_url }}" target="_blank">Open PDF</a>
