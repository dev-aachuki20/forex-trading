            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{ $allKeysProvider['include_manager'] }}</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card-header align-items-center d-flex">
                            ...
                            @elseif($viewMode)
                            <h4 class="card-title mb-0 flex-grow-1">{{$allKeysProvider['view_include_manager']}}</h4>
                            <div class="flex-shrink-0">
                                <div class="form-check form-switch form-switch-right form-switch-md">
                                    <button wire:click.prevent="cancel" type="button" class="btn btn-success add-btn"><i class="ri-arrow-left-line"></i> {{$allKeysProvider['back']}}</button>
                                </div>
                        ...
                        <div class="card-body">
                            @if ($formMode)
                                @include('livewire.admin.include-manager.form', [
                                    'languageId' => $languageId,
                                ])
                            @elseif($viewMode)
                                @livewire('admin.include-manager.show', ['incId' => $incId])
                            @else
                                <div class="listjs-table" id="customerList">
                                    ...
                                    <div class="table-responsive mt-3 my-team-details table-record">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                @if ($incRecords->count() > 0)
                                                    @foreach ($incRecords as $record)
                                                        <tr>
                                                            ...
                                                            <td>{{ convertDateTimeFormat($record->created_at, 'date') }}
                                                            </td>
                                    ...
                                    {{ $incRecords->links('vendor.pagination.bootstrap-5') }}
                                    <!-- eng tab end -->
                                </div>
                            @endif
                        </div>
