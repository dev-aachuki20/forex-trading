                                            ...
                                            <thead class="table-light">
                                                <tr>
                                                    <th class="sort" data-sort="customer_name">
                                                        {{ getLocalization('sno') }}</th>
                                                    <th class="sort" data-sort="email">{{ getLocalization('name') }}
                                                    </th>
                                                    <th class="sort" data-sort="customer_name">
                                                        {{ getLocalization('code') }}</th>
                                                    <th class="sort" data-sort="date">
                                                        {{ getLocalization('createdat') }}</th>
                                                    <th class="sort" data-sort="status">
                                                        {{ getLocalization('status') }}</th>
                                                    <th class="sort" data-sort="action">
                                                        {{ getLocalization('action') }}</th>
                                                </tr>
                                            </thead>
                                                    ...
                                                    @foreach ($languages as $lang)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label class="switch">
                                                                    <input
                                                                        wire:click.prevent="toggle({{ $lang->id }})"
