                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="switch">
                                                        <input wire:click.prevent="toggle({{ $testimonial->id }},{{$keyIndex}})" id="switch-input-{{$activeTab}}-{{$keyIndex}}" class="switch-input" type="checkbox" {{ $testimonial->status == 1 ? 'checked' : '' }} />
