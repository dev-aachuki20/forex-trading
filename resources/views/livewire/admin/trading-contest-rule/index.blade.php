                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            @else
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <a href="{{ route('auth.contest') }}" type="button"
                                            class="btn btn-success add-btn"><i class="ri-arrow-left-line"></i>
                                                ...
                                                @if ($allContestRule->count() > 0)
                                                    @foreach ($allContestRule as $ruleIndex => $contestrule)
                                                        <tr>
                                                            ...
                                                            <td>{{ ucfirst($contestrule->instruction) }}</td>
                                                            <td>

                                                                @foreach (json_decode($contestrule->rules, true) as $rule)
                                                                    {{ ucfirst($rule['title']) }}
                                                                    <br>
                                                                @endforeach
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    <div class="view">
                                                                        <button type="button"
                                                                            wire:click="show({{ $contestrule->id }})"
                                                                    ...
                                                                    <div class="edit">
                                                                        <button type="button"
                                                                            wire:click="edit({{ $contestrule->id }})"
                                                                    ...
                                                                    <div class="remove">
                                                                        <button type="button"
                                                                            wire:click.prevent="delete({{ $contestrule->id }})"
