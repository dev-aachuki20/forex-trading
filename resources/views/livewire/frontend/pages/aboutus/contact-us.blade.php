                    ...
                    <div class="home-banner-text text-center">
                        ...
                        <div class="button-group justify-content-center mt-0">
                            <a class="custom-btn outline-color-white"
                                href="{{ $pageDetail ? $pageDetail->link_two : '' }}">{{ $pageDetail ? ucfirst($pageDetail->button_one) : '' }}</a>
                            <a class="custom-btn outline-color-white"
            ...
            <div class="row gap-24 mb-40">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="conatct-outer">
                        <a href="#">
                            <div class="contact-icon-inner d-flex align-items-center">
                                <div class="contact-icon-main"><img src="{{ asset('images/form-icon/sms.svg') }}"
                                        alt="sms"></div>
                                <div class="contact-text">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="conatct-outer">
                        <div class="contact-icon-inner d-flex align-items-center">
                            <div class="contact-icon-main"><img src="{{ asset('images/form-icon/map.svg') }}"
                                    alt="map"></div>
                            <div class="contact-text">
