<div class="outer-inner-container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-sm-12">
                    <div class="home-banner-text text-center">
                        <h1 class="text-white">Meet Our Founder</h1>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="section-head">
                        <h2 class="max-w-427">meet our founder</h2>
                        ...
                        <div class="button-group">
                            <a class="custom-btn outline-color-azul" href="#">Join My Team</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6 col-md-6 col-sm-12 align-self-center">
                    <div class="section-head">
                        <h2 class="mb-30">why build <br> <strong>surgetrader?</strong> find out<br> how it all started</h2>
                        <blockquote>
                            SurgeTrader is looking for long term relationships with great traders. We set out to create an experience for our traders to feel valued and want to set the new standard in the trading world.
                        </blockquote>
    ...
    <section class="left-text-sec overlay-dark-gradient padding-tb-120" style="background-image:url(images/meet-our-founder/bg-img.jpg)">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-sm-12">
                    <div class="section-head">
                        ...
                        <div class="button-group">
                            <a class="custom-btn outline-color-azul" href="#">Choose your account size</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                        ...
                        <div class="side-by-step-item">
                            <a href="#">
                                ...
                                <div class="step-details">
                                    <h4 class="mb-0">Choose your account size and the ForexTrader Audition.</h4>
                                </div>
                            </a>
                        </div>
                        <div class="side-by-step-item">
                            <a href="#">
                                ...
                                <div class="step-details">
                                    <h4 class="mb-0">Achieve a 10% profit target without breaching two straightforward rules.</h4>
                                </div>
                            </a>
                        </div>
                    </div>
