                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-sm-12">
                                                <div class="faq-videos">
                                                    <div class="box-video">
                                                        <div class="bg-video" style="background-image: url({{$record->image_url}});">
                                                            <div class="bt-play">
                                                        ...
                                                        <div class="video-container">
                                                            <video id="faq-affiliate-{{$record->id}}" width="560" height="315" controls>
                                                                <source src="{{$record->faqVideo->file_url}}">
                                                                <!-- <source src="video/video.mp4" type="video/mp4"> -->
                                                                <source src="video/video.ogg" type="video/{{$record->faqVideo->extension}}">
                                                            </video>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="icons">
                        ...
                        <li>
                            <a href="javascript:void(0);" target="_blank" id="twitter" onclick="shareOnTwitter()">
