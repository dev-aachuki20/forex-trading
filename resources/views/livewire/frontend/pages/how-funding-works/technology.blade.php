            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-sm-12">
                    <div class="home-banner-text text-center">
                        <h1 class="text-white">Feel the Surge</h1>
                        <div class="discription text-white body-font-large mb-30">
                            <p> Easy-to-use proprietary trading dashboards give you the tools you need to trade with best practices.</p>
                        </div>
                        <div class="button-group justify-content-center mt-0">
                            <a class="custom-btn fill-btn" href="get-funded.html">Get Funded</a>
                        </div>
                    </div>
                </div>
            </div>
