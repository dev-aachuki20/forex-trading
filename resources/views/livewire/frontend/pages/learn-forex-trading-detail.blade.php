                ...
                <div class="row gap-24">
                    <div class="col-lg-8 col-sm-12">
                        ...
                        <div class="video-detail-share">
                            <h5>1.2 What is Forex?</h5>
                            <ul>
                                <li><a href="javascript:void(0);"> <img src="{{asset('images/trading-video/like.svg')}}" alt="like">1.7 K</a></li>
                                <li><a href="javascript:void(0);"> <img src="{{asset('images/trading-video/dislike.svg')}}" alt="dislike">632</a></li>
                                <li>
                        ...
                        <div class="video-detail-discription">
                            <h4>{{$activeLecture ? ucfirst($activeLecture->name) : ''}}</h4>
