            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-sm-12">
                    <div class="home-banner-text text-center">
                        <h1 class="text-white">Trader Resources</h1>
                        <div class="discription text-white body-font-large mb-0">
                            <p> Find a wealth of information for traders — from strategy to risk management to technical analysis and everything in between.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="blog-list">
                <div class="row align-items-center gap-24">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="section-head">
                            <h2>everything you need to know about moving averages</h2>
                            <div class="discription">
                                <p>In this whitepaper, find out about simple moving averages, exponential moving averages, how to find a trend, what a crossover means, moving average envelopes, the Guppy Multiple Moving Average and more.</p>
                            </div>
                            <div class="button-group">
                                <a class="custom-btn outline-color-azul" href="#">Download Now</a>
                            </div>
                        </div>
                    </div>
                </div>
