<div class="our-philanthropy-logo">
    <ul>
        @dd($sectionDetail->multiple_image_urls)
        <li><img src="{{$sectionDetail->multiple_image_urls ? $sectionDetail->multiple_image_urls : config('constants.section_image_default.philanthropy_img1') }}" alt="logo-1"></li>
