            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-sm-12">
                    <div class="section-head text-center">
                        <h2>{{ $sectionDetail ? ucwords($sectionDetail->title) : 'Features' }}</h2>
                    ...
                    <div class="position-relative box-card">
                        ...
                        <div class="box-text">
                            ...
                            <div class="button-group">
                                <a class="custom-btn outline-color-azul stretched-link" href="{{ route('get-funded') }}">{{ $allKeysProvider['start_trading'] ?? 'Start Trading'}}</a>
                            </div>
                        </div>
                    </div>
                </div>
